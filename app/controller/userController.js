...
async function loginUser(req, res) {
    try {
        ...
        res.cookie("refreshToken", refreshToken, { httpOnly: true, sameSite: 'none', secure: true, expire : new Date(new Date().getTime()+36000000) })
        .cookie("accessToken", accessToken, { httpOnly: true, sameSite: 'none', secure: true, expire : new Date(new Date().getTime()+20000) }).send();
